...
public class TodoController {
    ...
    @PostMapping
    public ResponseEntity<TodoDtos.TodoResponseDto>createTodo(
            @RequestBody TodoDtos.TodoCreateRequestDto requestDto,
    ...
    @PostMapping("/{id}")
    public ResponseEntity<TodoDtos.TodoResponseDto> toggleTodo(
